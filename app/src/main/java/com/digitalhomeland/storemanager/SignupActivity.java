                ...
                alertDialogBuilderTeacherInput
                        ...
                        .setPositiveButton("Send", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialogBox, int id) {
                                ...
                                Log.d("myTag", "dailog input : " + userInputDialogEditText.getText()  + " : match : " + db.getStore().getStoreId());
                                // if it is equal to schoolId recieved from page 1
                                if(userInputDialogEditText.getText().toString().equals(db.getStore().getStoreId())) {
                                    response += "\"" + "firstName" + "\":\"" + firstName.getText().toString() + "\"," + "\"" + "middleName" + "\":\"" + middleName.getText().toString() + "\"," + "\"" + "lastName" + "\":\"" + lastName.getText().toString() + "\", \""  + "phone" + "\":\"" + phone.getText().toString() + "\",\""  + "email" + "\":\"" + email.getText().toString() + "\"," + "\"" + "aadharId" + "\":\"" + aadharId.getText().toString() + "\"," + "\"" + "employeeId" + "\":\"" + employeeId.getText().toString() + "\"," + "\"" + "isManager" + "\":\"" + "true" + "\"," + "\"" + "storeId" + "\":\"" + userInputDialogEditText.getText() + "\",";
