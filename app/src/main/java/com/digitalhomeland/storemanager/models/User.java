...
public class User {
    ...
    public User(String _id, String firstName, String middleName, String lastName, String phone, String email,String aadharId, String employeeId, String storeId, String teamName, String designation)
    {
        this._id = _id;
        this.firstName = firstName;
        this.middleName = middleName;
